        ...
        <>
            <div class="w-screen py-6 px-10 flex justify-between items-center">
                ...
                <div class="flex justify-center items-center space-x-10">
                    <Link href="/admin-panel" class={`${poppins.className} text-sm font-medium cursor-pointer hover:ease-in transition duration-150 hover:text-gray-400`}>Inventory</Link>
